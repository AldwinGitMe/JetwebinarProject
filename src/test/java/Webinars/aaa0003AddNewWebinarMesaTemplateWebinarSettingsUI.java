...
public class aaa0003AddNewWebinarMesaTemplateWebinarSettingsUI {
	...
	public void Test_Webinar_Settings_Title_Is_Present() throws IOException, ParseException, InterruptedException {
		...
		Thread.sleep(3000);
		// hover and then click USE MESA button
		...
		dothis.hoverpointer(usemesabuttoncsslocator);
		dothis.click_button_linktext(usemesabuttoncsslocator);
		Thread.sleep(2000);
