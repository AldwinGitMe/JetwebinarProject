...
public class aaa0007AddNewWebinarChicagoTemplateWebinarSettingsUI {
	...
	public void Test_Webinar_Settings_Title_Is_Present() throws IOException, ParseException, InterruptedException {
		...
		String useoakbuttoncsslocator = (String) dothis.dashboardpanel.get("csslocator");
		dothis.hoverpointer(useoakbuttoncsslocator);
		dothis.click_button_linktext(useoakbuttoncsslocator);
		Thread.sleep(2000);
