...
public class aaa0050AddNewAdelineTemplate_LiveWebinar_InstantReplay_GoesTo_AllWebinarsPage {
	...
	@Test(priority = 1)
	public void Test_If_AddNewAdelimeTemplate_LiveWebinar_InstantReplay_It_Should_GoesTo_CorrectPath()
		...
		dothis.selectOptionvalue(eventtypeselectioncsslocator, "instant");
	...
	@Test(priority = 2)
	public void Test_If_The_RecentCreated_LiveWebinar_InstantReplay_Appear_At_AllWebinarsPage()
			throws IOException, ParseException, InterruptedException {
		reusableTestMethods dothis = new reusableTestMethods(driver);
	...
	@Test(priority = 3)
	public void Test_If_The_RecentCreated_LiveWebinar_InstantReplay_Has_No_BroadcastButton()
			throws IOException, ParseException, InterruptedException {
		reusableTestMethods dothis = new reusableTestMethods(driver);
		dothis.checkifitHasNoStartLiveBroadcastbutton_On3rdColumn();
	}

	@Test(priority = 4)
	public void Test_If_The_RecentCreated_LiveWebinar_InstantReplay_Has_WebinarLink_Enabled_CorrectLinkText()
	...
	@Test(priority = 5)
	public void Test_If_The_RecentCreated_LiveWebinar_InstantReplay_Has_EditLink_Enabled_Correctlinktext()
			throws IOException, ParseException {
		reusableTestMethods dothis = new reusableTestMethods(driver);
	...
	@Test(priority = 6)
	public void Test_If_The_RecentCreated_LiveWebinar_InstantReplay_Has_CopyLink_Enabled_Correctlinktext()
			throws IOException, ParseException {
		reusableTestMethods dothis = new reusableTestMethods(driver);
	...
	@Test(priority = 7)
	public void Test_If_The_RecentCreated_LiveWebinar_InstantReplay_Has_DeleteLink_Enabled_Correctlinktext()
			throws IOException, ParseException {
		reusableTestMethods dothis = new reusableTestMethods(driver);
