...
public class aaa0018AddNewAdelineTemplate_LiveWebinar_GoesTo_AllWebinarsPage {
	...
	@Test(priority = 1)
	public void Test_If_AddNewAdelimeTemplate_LiveWebinar_It_Should_GoesTo_CorrectPath()
		...
		// hover and then click USER ADELINE button
		...
		// select event type but use default which is Live Broadcast so skip here
		...
		dothis.enterdataInputfield(inputdatefieldcsslocator, thistime);
	...
	@Test(priority = 2)
	public void Test_If_The_Recent_CreatedLiveWebinar_Appears_inLastRow_At_AllWebinarsTablePage() throws IOException, ParseException, InterruptedException {
		reusableTestMethods dothis = new reusableTestMethods(driver);
	...
	@Test(priority = 3)
	public void Test_If_The_Created_LiveWebinar_Has_StartLiveBroadcast_button_Enabled_CorrectButtonName_ButtonHasIconandWithCorrectIconName() throws IOException, ParseException {
		reusableTestMethods dothis = new reusableTestMethods(driver);
		dothis.dashboardpanel = (JSONObject) dothis.AllWebinarsPageArr.get(0);
		String expectediconName = (String) dothis.dashboardpanel.get("buttonIconName");
		dothis.checkifitHasStartLiveBroadcastbutton_Enabled_and_CorrectName("START LIVE BROADCAST", "class", expectediconName);
	}
	
	@Test(priority = 4)
	public void Test_If_The_Created_LiveWebinar_Has_WebinarLink_Enabled_CorrectLinkText() throws IOException, ParseException {
		reusableTestMethods dothis = new reusableTestMethods(driver);
		dothis.dashboardpanel = (JSONObject) dothis.AllWebinarsPageArr.get(0);
	...
	@Test(priority = 5)
	public void Test_If_The_Created_LiveWebinar_Has_EditLink_Enabled_Correctlinktext() throws IOException, ParseException {
		reusableTestMethods dothis = new reusableTestMethods(driver);
	...
	@Test(priority = 6)
	public void Test_If_The_Created_LiveWebinar_Has_CopyLink_Enabled_Correctlinktext() throws IOException, ParseException {
		reusableTestMethods dothis = new reusableTestMethods(driver);
		dothis.checkifcreatedwebinarhasCopylink_enabled_correctlinktext();
	}
	
	@Test(priority = 7)
	public void Test_If_The_Created_LiveWebinar_Has_DeleteLink_Enabled_Correctlinktext() throws IOException, ParseException {
		reusableTestMethods dothis = new reusableTestMethods(driver);
