...
public class aaa0019AddNewMesaTemplate_LiveWebinar_GoesTo_AllWebinarsPage {
	...
	@Test(priority = 1)
	public void Test_If_AddNewMesaTemplate_LiveWebinar_It_Should_GoesTo_CorrectPath()
		...
		// hover and then click USER MESA button
